...
import com.tiny.spring.framework.annotation.AfterReturning;
import com.tiny.spring.framework.annotation.Aspect;
import com.tiny.spring.framework.annotation.Controller;
import com.tiny.spring.framework.annotation.RequestMapping;
import com.tiny.spring.framework.annotation.ResponseBody;
import com.tiny.spring.framework.annotation.RestController;
import com.tiny.spring.framework.annotation.Transactional;
import com.tiny.spring.mysql.Db;

import com.alibaba.fastjson.JSONObject;
import com.tiny.spring.common.Constants;
...
public class HttpServerHandler extends IoHandlerAdapter {
	...
	private void handleRequest(final IoSession session, HttpRequest request) throws Exception {
		...
		if (foundRestMethod != null) {
			...
			com.tiny.spring.framework.Controller controller = (com.tiny.spring.framework.Controller)klass.newInstance();
			Object result = null;
			try {
				if (tx != null) {
					Db.startTransaction();
